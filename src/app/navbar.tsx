        ...
        <nav className="flex bg-gray-600 py-2 px-5 justify-between">
            <div className="flex">
                ...
                <ul className="flex ml-5">
                    <Link href={"/"}>
                        <li
                            className={`mr-3 ${pathname === "/" ? "text-red-300" : "text-white"} 
                    cursor-pointer`}>Home</li>
                    </Link>
                    <Link href={"/about"}>
                        <li
                            className={`mr-3 ${pathname === "/about" ? "text-red-300" : "text-white"} 
                     cursor-pointer`}>About</li>
                    </Link>
                    <Link href={"/about/profile"}>
                        <li
                            className={`mr-3 ${pathname === "/about/profile" ? "text-red-300" : "text-white"} 
